      ...
      <div className="container mx-auto py-8">
        <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10 ">
          <div className="w-full lg:h-72 mt-0 top-0 text-center">
            <h2 className="text-left font-bold text-gray-800 mt-4"></h2>
            <img  width="200" height="200" alt="Product" className="lg:w-10/12 w-full h-full rounded-xl object-cover object-top" />
          ...
          <div className="ml-auto">
            <div className="flex flex-wrap items-start gap-0">
              <div className="ml-left gap-4">
                <h2 className="text-xl font-extrabold text-gray-800">Berber Ana Sayfa</h2>
                <p className="text-sm text-gray-400 mt-2">berberbul.com</p>
              </div>
            ...
            <div>
              ...
              <table class="w-full mt-4">
                ...
                <tbody>
                    ...
                    <tr >
                      <td class="py-2 px-4 border border-gray-200">1</td>
                      <td class="py-2 px-4 border border-gray-200">1</td>
                      <td class="py-2 px-4 border border-gray-200">1</td>
